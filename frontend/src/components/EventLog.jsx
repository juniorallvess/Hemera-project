...
export default function EventLog({ items, full = false }) {
  return (
    <aside
      ...
      } bg-surface-container-lowest rounded-xl shadow-[0_2px_16px_rgba(58,48,42,0.04)] border border-outline-variant/30 p-6 h-fit max-h-[calc(100vh-8rem)] overflow-y-auto scroll-mt-24`}
    >
